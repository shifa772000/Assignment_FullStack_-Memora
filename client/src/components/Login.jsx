...
// 💡 المتغير الجديد للمسار الصحيح
const PEOPLE_LIST_ROUTE = "/MemoraFavouritePeople"; // 👈 تم التعديل هنا
...
      // 💡 التعديل الأول: إعادة التوجيه بعد نجاح تسجيل الدخول
      navigate(PEOPLE_LIST_ROUTE);
    } catch (error) {
...
  useEffect(() => {
    if (user) {
      // 💡 التعديل الثاني: إعادة التوجيه التلقائية إذا كان المستخدم مسجل الدخول بالفعل
      navigate(PEOPLE_LIST_ROUTE);
    }
  }, [user, navigate]);
